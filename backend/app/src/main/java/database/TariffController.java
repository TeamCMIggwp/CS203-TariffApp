...
public class TariffController {
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(
            ...
            content = @Content(
                mediaType = "application/json",
                examples = @ExampleObject(
                    value = "{\"timestamp\": \"2025-10-14T10:30:00\", \"status\": 404, \"error\": \"Not Found\", \"message\": \"Tariff not found for: reporter=840, partner=356, product=100630, year=2020\", \"path\": \"/api/v1/tariffs/840/356/100630/2020\"}"
                )
            )
        )
    })
    ...
    @Operation(
        summary = "Get tariff rate",
        description = "Retrieves a specific tariff rate by composite key"
    )
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200",
