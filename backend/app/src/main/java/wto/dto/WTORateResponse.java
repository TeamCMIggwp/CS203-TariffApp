...
public class WTORateResponse {

    @JsonProperty("code") private String code;
    @JsonProperty("name") private String name;
    @JsonProperty("categoryCode") private String categoryCode;
    @JsonProperty("categoryLabel") private String categoryLabel;
    @JsonProperty("subcategoryCode") private String subcategoryCode;
    @JsonProperty("subcategoryLabel") private String subcategoryLabel;
    @JsonProperty("unitCode") private String unitCode;
    @JsonProperty("unitLabel") private String unitLabel;
    @JsonProperty("startYear") private Integer startYear;
    @JsonProperty("endYear") private Integer endYear;
    @JsonProperty("frequencyCode") private String frequencyCode;
    @JsonProperty("frequencyLabel") private String frequencyLabel;
    @JsonProperty("numberReporters") private Integer numberReporters;
    @JsonProperty("numberPartners") private Integer numberPartners;
    @JsonProperty("productSectorClassificationCode") private String productSectorClassificationCode;
    @JsonProperty("productSectorClassificationLabel") private String productSectorClassificationLabel;
    @JsonProperty("hasMetadata") private String hasMetadata;
    @JsonProperty("numberDecimals") private Integer numberDecimals;
    @JsonProperty("numberDatapoints") private Long numberDatapoints;
    @JsonProperty("updateFrequency") private String updateFrequency;
    @JsonProperty("description") private String description;
    @JsonProperty("sortOrder") private Integer sortOrder;
