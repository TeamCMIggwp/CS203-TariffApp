        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-white text-black p-4 pb-32">
                ...
                >
                    ...
                    <g>
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("706")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("706")}
                            className={`cursor-pointer ${hoveredCountry === "706" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("784")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("784")}
                            className={`cursor-pointer ${hoveredCountry === "784" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="004" // Afghanistan 
                            ...
                            onMouseEnter={() => setHoveredCountry("004")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("004")}
                            className={`cursor-pointer ${hoveredCountry === "004" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="008" // Albania
                            ...
                            onMouseEnter={() => setHoveredCountry("008")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("008")}
                            className={`cursor-pointer ${hoveredCountry === "008" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="051" // Armenia
                            d="M507.47,420.549l4.149,5.411l-1.218,1.427l-2.939-0.51l-3.646-3.268l0.196-2.146L507.47,420.549L507.47,420.549z"
                            onMouseEnter={() => setHoveredCountry("051")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("051")}
                            className={`cursor-pointer ${hoveredCountry === "051" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="024" // Angola
                            onMouseEnter={() => setHoveredCountry("024")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("024")}
                            className={`cursor-pointer ${hoveredCountry === "024" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <g
                            id="032" // Argentina
                            onMouseEnter={() => setHoveredCountry("032")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("032")}
                            className={`cursor-pointer ${hoveredCountry === "032" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("040")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("040")}
                            className={`cursor-pointer ${hoveredCountry === "040" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="036" // Australia
                            onMouseEnter={() => setHoveredCountry("036")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("036")}
                            className={`cursor-pointer ${hoveredCountry === "036" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("031")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("031")}
                            className={`cursor-pointer ${hoveredCountry === "031" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="070" // Bosnia and Herzegovina
                            d="M442.708,411.084l-0.319,0.527l5.801,5.981l2.127-3.13l-0.078-1.234l-1.857-2.256L442.708,411.084L442.708,411.084z"
                            onMouseEnter={() => setHoveredCountry("070")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("070")}
                            className={`cursor-pointer ${hoveredCountry === "070" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="050" // Bangladesh
                            ...
                            onMouseEnter={() => setHoveredCountry("050")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("050")}
                            className={`cursor-pointer ${hoveredCountry === "050" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="056" // Belgium 
                            ...
                            onMouseEnter={() => setHoveredCountry("056")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("056")}
                            className={`cursor-pointer ${hoveredCountry === "056" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="854" // Burkina Faso
                            ...
                            onMouseEnter={() => setHoveredCountry("854")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("854")}
                            className={`cursor-pointer ${hoveredCountry === "854" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="100" // Bulgaria
                            ...
                            onMouseEnter={() => setHoveredCountry("100")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("100")}
                            className={`cursor-pointer ${hoveredCountry === "100" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="108" // Burundi
                            d="M478.504,538.385l3.691-0.078l-0.959,3.232l-0.935,0.812h-1.142l-0.812-2.187L478.504,538.385L478.504,538.385z"
                            onMouseEnter={() => setHoveredCountry("108")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("108")}
                            className={`cursor-pointer ${hoveredCountry === "108" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="204" // Benin
                            ...
                            onMouseEnter={() => setHoveredCountry("204")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("204")}
                            className={`cursor-pointer ${hoveredCountry === "204" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="096" // Brunei
                            d="M689.038,515.08l-2.489,3.018l2.04,0.641l1.149-1.608L689.038,515.08L689.038,515.08z"
                            onMouseEnter={() => setHoveredCountry("096")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("096")}
                            className={`cursor-pointer ${hoveredCountry === "096" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="068" // Bolivia
                            ...
                            onMouseEnter={() => setHoveredCountry("068")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("068")}
                            className={`cursor-pointer ${hoveredCountry === "068" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="076" // Brazil
                            ...
                            onMouseEnter={() => setHoveredCountry("076")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("076")}
                            className={`cursor-pointer ${hoveredCountry === "076" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="044" // Bahamas
                            onMouseEnter={() => setHoveredCountry("044")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("044")}
                            className={`cursor-pointer ${hoveredCountry === "044" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("064")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("064")}
                            className={`cursor-pointer ${hoveredCountry === "064" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="072" // Botswana
                            ...
                            onMouseEnter={() => setHoveredCountry("072")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("072")}
                            className={`cursor-pointer ${hoveredCountry === "072" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="112" // Belarus
                            ...
                            onMouseEnter={() => setHoveredCountry("112")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("112")}
                            className={`cursor-pointer ${hoveredCountry === "112" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="084" // Belize
                            d="M191.823,483.228l-0.043,3.154h0.726l2.472-4.615h-1.677L191.823,483.228L191.823,483.228z"
                            onMouseEnter={() => setHoveredCountry("084")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("084")}
                            className={`cursor-pointer ${hoveredCountry === "084" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="124" // Canada
                            onMouseEnter={() => setHoveredCountry("124")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("124")}
                            className={`cursor-pointer ${hoveredCountry === "124" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            id="180" // Democratic Republic of Congo
                            ...
                            onMouseEnter={() => setHoveredCountry("180")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("180")}
                            className={`cursor-pointer ${hoveredCountry === "180" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("140")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("140")}
                            className={`cursor-pointer ${hoveredCountry === "140" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="178" // Congo
                            ...
                            onMouseEnter={() => setHoveredCountry("178")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("178")}
                            className={`cursor-pointer ${hoveredCountry === "178" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="756" // Switzerland
                            ...
                            onMouseEnter={() => setHoveredCountry("756")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("756")}
                            className={`cursor-pointer ${hoveredCountry === "756" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("384")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("384")}
                            className={`cursor-pointer ${hoveredCountry === "384" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="152" // Chile
                            onMouseEnter={() => setHoveredCountry("152")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("152")}
                            className={`cursor-pointer ${hoveredCountry === "152" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("120")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("120")}
                            className={`cursor-pointer ${hoveredCountry === "120" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="156" // China
                            onMouseEnter={() => setHoveredCountry("156")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("156")}
                            className={`cursor-pointer ${hoveredCountry === "156" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("170")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("170")}
                            className={`cursor-pointer ${hoveredCountry === "170" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="188" // Costa Rica
                            d="M202.905,502.745l1.202,2.352l0.977,1.297l-1.314,3.898l-2.507-1.764l-4.097-3.752v-2.48L202.905,502.745L202.905,502.745z"
                            onMouseEnter={() => setHoveredCountry("188")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("188")}
                            className={`cursor-pointer ${hoveredCountry === "188" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="192" // Cuba
                            ...
                            onMouseEnter={() => setHoveredCountry("192")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("192")}
                            className={`cursor-pointer ${hoveredCountry === "192" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="132" // Cabo Verde (Cape Verde)
                            onMouseEnter={() => setHoveredCountry("132")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("132")}
                            className={`cursor-pointer ${hoveredCountry === "132" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("196")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("196")}
                            className={`cursor-pointer ${hoveredCountry === "196" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="203" // Czech Republic (Czechia / Czech)
                            ...
                            onMouseEnter={() => setHoveredCountry("203")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("203")}
                            className={`cursor-pointer ${hoveredCountry === "203" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="276" // Germany
                            ...
                            onMouseEnter={() => setHoveredCountry("276")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("276")}
                            className={`cursor-pointer ${hoveredCountry === "276" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="208" // Denmark
                            onMouseEnter={() => setHoveredCountry("208")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("208")}
                            className={`cursor-pointer ${hoveredCountry === "208" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("262")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("262")}
                            className={`cursor-pointer ${hoveredCountry === "262" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="212" // Dominica 
                            d="M256.23,485.371l-0.761,1.616l0.917,1.228l1.141-0.994L256.23,485.371L256.23,485.371z"
                            onMouseEnter={() => setHoveredCountry("212")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("212")}
                            className={`cursor-pointer ${hoveredCountry === "212" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("214")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("214")}
                            className={`cursor-pointer ${hoveredCountry === "214" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="012" // Algeria
                            ...
                            onMouseEnter={() => setHoveredCountry("012")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("012")}
                            className={`cursor-pointer ${hoveredCountry === "012" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="218" // Ecuador
                            onMouseEnter={() => setHoveredCountry("218")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("218")}
                            className={`cursor-pointer ${hoveredCountry === "218" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <g
                            id="233" // Estonia
                            onMouseEnter={() => setHoveredCountry("233")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("233")}
                            className={`cursor-pointer ${hoveredCountry === "233" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("818")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("818")}
                            className={`cursor-pointer ${hoveredCountry === "818" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="232" // Eritrea
                            ...
                            onMouseEnter={() => setHoveredCountry("232")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("232")}
                            className={`cursor-pointer ${hoveredCountry === "232" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="724" // Spain
                            onMouseEnter={() => setHoveredCountry("724")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("724")}
                            className={`cursor-pointer ${hoveredCountry === "724" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("231")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("231")}
                            className={`cursor-pointer ${hoveredCountry === "231" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="246" // Finland 
                            ...
                            onMouseEnter={() => setHoveredCountry("246")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("246")}
                            className={`cursor-pointer ${hoveredCountry === "246" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="238" // Falkland Islands
                            onMouseEnter={() => setHoveredCountry("238")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("238")}
                            className={`cursor-pointer ${hoveredCountry === "238" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <g
                            id="250" // France
                            onMouseEnter={() => setHoveredCountry("250")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("250")}
                            className={`cursor-pointer ${hoveredCountry === "250" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("266")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("266")}
                            className={`cursor-pointer ${hoveredCountry === "266" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="826" // United Kingdom
                            onMouseEnter={() => setHoveredCountry("826")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("826")}
                            className={`cursor-pointer ${hoveredCountry === "826" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("268")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("268")}
                            className={`cursor-pointer ${hoveredCountry === "268" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="288" // Ghana 
                            ...
                            onMouseEnter={() => setHoveredCountry("288")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("288")}
                            className={`cursor-pointer ${hoveredCountry === "288" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="304" // Greenland
                            onMouseEnter={() => setHoveredCountry("304")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("304")}
                            className={`cursor-pointer ${hoveredCountry === "304" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("270")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("270")}
                            className={`cursor-pointer ${hoveredCountry === "270" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="324" // Guinea
                            ...
                            onMouseEnter={() => setHoveredCountry("324")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("324")}
                            className={`cursor-pointer ${hoveredCountry === "324" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="226" // Equatorial Guinea
                            onMouseEnter={() => setHoveredCountry("226")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("226")}
                            className={`cursor-pointer ${hoveredCountry === "226" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <g
                            id="300" // Greece
                            onMouseEnter={() => setHoveredCountry("300")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("300")}
                            className={`cursor-pointer ${hoveredCountry === "300" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("320")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("320")}
                            className={`cursor-pointer ${hoveredCountry === "320" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="624" // Guinea-Bissau
                            d="M368.196,502.356l1.211,2.395l3.396-2.922l0.035-0.899l-4.003-0.579L368.196,502.356L368.196,502.356z"
                            onMouseEnter={() => setHoveredCountry("624")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("624")}
                            className={`cursor-pointer ${hoveredCountry === "624" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="328" // Guyana
                            ...
                            onMouseEnter={() => setHoveredCountry("328")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("328")}
                            className={`cursor-pointer ${hoveredCountry === "328" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="340" // Honduras
                            ...
                            onMouseEnter={() => setHoveredCountry("340")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("340")}
                            className={`cursor-pointer ${hoveredCountry === "340" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="191" // Croatia
                            ...
                            onMouseEnter={() => setHoveredCountry("191")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("191")}
                            className={`cursor-pointer ${hoveredCountry === "191" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="332" // Haiti
                            ...
                            onMouseEnter={() => setHoveredCountry("332")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("332")}
                            className={`cursor-pointer ${hoveredCountry === "332" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="348" // Hungary
                            ...
                            onMouseEnter={() => setHoveredCountry("348")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("348")}
                            className={`cursor-pointer ${hoveredCountry === "348" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="360" // Indonesia
                            onMouseEnter={() => setHoveredCountry("360")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("360")}
                            className={`cursor-pointer ${hoveredCountry === "360" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("372")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("372")}
                            className={`cursor-pointer ${hoveredCountry === "372" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="376" // Israel
                            d="M486.378,444.899l-1.365,4.348l1.771,5.213l2.031-7.616v-1.633L486.378,444.899L486.378,444.899z"
                            onMouseEnter={() => setHoveredCountry("376")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("376")}
                            className={`cursor-pointer ${hoveredCountry === "376" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="356" // India
                            ...
                            onMouseEnter={() => setHoveredCountry("356")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("356")}
                            className={`cursor-pointer ${hoveredCountry === "356" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="368" // Iraq
                            ...
                            onMouseEnter={() => setHoveredCountry("368")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("368")}
                            className={`cursor-pointer ${hoveredCountry === "368" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="364" // Iran
                            ...
                            onMouseEnter={() => setHoveredCountry("364")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("364")}
                            className={`cursor-pointer ${hoveredCountry === "364" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="352" // Iceland 
                            ...
                            onMouseEnter={() => setHoveredCountry("352")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("352")}
                            className={`cursor-pointer ${hoveredCountry === "352" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="380" // Italy
                            onMouseEnter={() => setHoveredCountry("380")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("380")}
                            className={`cursor-pointer ${hoveredCountry === "380" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("388")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("388")}
                            className={`cursor-pointer ${hoveredCountry === "388" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="400" // Jordan 
                            ...
                            onMouseEnter={() => setHoveredCountry("400")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("400")}
                            className={`cursor-pointer ${hoveredCountry === "400" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="392" // Japan
                            onMouseEnter={() => setHoveredCountry("392")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("392")}
                            className={`cursor-pointer ${hoveredCountry === "392" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("404")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("404")}
                            className={`cursor-pointer ${hoveredCountry === "404" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="417" // Kyrgyzstan
                            ...
                            onMouseEnter={() => setHoveredCountry("417")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("417")}
                            className={`cursor-pointer ${hoveredCountry === "417" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="116" // Cambodia 
                            ...
                            onMouseEnter={() => setHoveredCountry("116")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("116")}
                            className={`cursor-pointer ${hoveredCountry === "116" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="174" // Comoros
                            d="M514.359,560.013l0.396,1.321l1.711,0.269l0.656-1.72L514.359,560.013L514.359,560.013z"
                            onMouseEnter={() => setHoveredCountry("174")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("174")}
                            className={`cursor-pointer ${hoveredCountry === "174" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="408" // North Korea (Democratic Republic of Korea)
                            ...
                            onMouseEnter={() => setHoveredCountry("408")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("408")}
                            className={`cursor-pointer ${hoveredCountry === "408" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="410" // South Korea
                            ...
                            onMouseEnter={() => setHoveredCountry("410")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("410")}
                            className={`cursor-pointer ${hoveredCountry === "410" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="414" // Kuwait
                            d="M519.2,452.774l-1.945-1.056l-1.349,1.356l0.146,2.715l3.139,1.201L519.2,452.774L519.2,452.774z"
                            onMouseEnter={() => setHoveredCountry("414")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("414")}
                            className={`cursor-pointer ${hoveredCountry === "414" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="398" // Kazakhstan
                            ...
                            onMouseEnter={() => setHoveredCountry("398")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("398")}
                            className={`cursor-pointer ${hoveredCountry === "398" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="418" // Laos
                            ...
                            onMouseEnter={() => setHoveredCountry("418")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("418")}
                            className={`cursor-pointer ${hoveredCountry === "418" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="422" // Lebanon
                            d="M487.139,440.041l0.053,1.686l-0.708,2.56l2.438,0.208l0.156-3.631L487.139,440.041L487.139,440.041z"
                            onMouseEnter={() => setHoveredCountry("422")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("422")}
                            className={`cursor-pointer ${hoveredCountry === "422" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="662" // Saint Lucia
                            d="M258.746,493.28l-0.614,1.306l0.994,1.071l1.296-0.691L258.746,493.28L258.746,493.28z"
                            onMouseEnter={() => setHoveredCountry("662")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("662")}
                            className={`cursor-pointer ${hoveredCountry === "662" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="144" // Sri Lanka
                            ...
                            onMouseEnter={() => setHoveredCountry("144")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("144")}
                            className={`cursor-pointer ${hoveredCountry === "144" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="430" // Liberia
                            d="M378.198,515.027l9.491,6.345l-0.227-4.805l-2.869-3.38l-2.801-2.481L378.198,515.027L378.198,515.027z"
                            onMouseEnter={() => setHoveredCountry("430")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("430")}
                            className={`cursor-pointer ${hoveredCountry === "430" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="426" // Lesotho
                            ...
                            onMouseEnter={() => setHoveredCountry("426")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("426")}
                            className={`cursor-pointer ${hoveredCountry === "426" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="440" // Lithuania
                            ...
                            onMouseEnter={() => setHoveredCountry("440")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("440")}
                            className={`cursor-pointer ${hoveredCountry === "440" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="442" // Luxembourg
                            d="M420.424,397.582l0.76,0.679l0.88,0.083l0.194-1.734l-0.253-0.974l-1.224,0.583L420.424,397.582z"
                            onMouseEnter={() => setHoveredCountry("442")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("442")}
                            className={`cursor-pointer ${hoveredCountry === "442" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="428" // Latvia
                            ...
                            onMouseEnter={() => setHoveredCountry("428")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("428")}
                            className={`cursor-pointer ${hoveredCountry === "428" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="434" // Libya
                            ...
                            onMouseEnter={() => setHoveredCountry("434")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("434")}
                            className={`cursor-pointer ${hoveredCountry === "434" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="504" // Morocco
                            ...
                            onMouseEnter={() => setHoveredCountry("504")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("504")}
                            className={`cursor-pointer ${hoveredCountry === "504" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="498" // Moldova
                            ...
                            onMouseEnter={() => setHoveredCountry("498")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("498")}
                            className={`cursor-pointer ${hoveredCountry === "498" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="499" // Montenegro 
                            d="M449.68,416.677l-1.266,1.789l0.362,1.099l1.504,0.275l1.184-1.607L449.68,416.677z"
                            onMouseEnter={() => setHoveredCountry("499")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("499")}
                            className={`cursor-pointer ${hoveredCountry === "499" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="450" // Madagascar
                            ...
                            onMouseEnter={() => setHoveredCountry("450")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("450")}
                            className={`cursor-pointer ${hoveredCountry === "450" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="807" // Macedonia
                            d="M456.643,418.924l-2.912,0.959l0.139,2.473l0.683,0.873l3.458-1.606L456.643,418.924L456.643,418.924z"
                            onMouseEnter={() => setHoveredCountry("807")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("807")}
                            className={`cursor-pointer ${hoveredCountry === "807" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="466" // Mali
                            ...
                            onMouseEnter={() => setHoveredCountry("466")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("466")}
                            className={`cursor-pointer ${hoveredCountry === "466" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="104" // Myanmar
                            ...
                            onMouseEnter={() => setHoveredCountry("104")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("104")}
                            className={`cursor-pointer ${hoveredCountry === "104" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="496" // Mongolia
                            ...
                            onMouseEnter={() => setHoveredCountry("496")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("496")}
                            className={`cursor-pointer ${hoveredCountry === "496" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="478" // Mauritania
                            ...
                            onMouseEnter={() => setHoveredCountry("478")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("478")}
                            className={`cursor-pointer ${hoveredCountry === "478" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="470" // Malta
                            d="M440.815,438.339l-1.443,0.294l0.052,1.6l1.297,0.433l0.579-0.484L440.815,438.339L440.815,438.339z"
                            onMouseEnter={() => setHoveredCountry("470")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("470")}
                            className={`cursor-pointer ${hoveredCountry === "470" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="480" // Mauritius
                            d="M544.89,584.008l-1.312,1.721l0.259,1.857l2.768-2.256L544.89,584.008L544.89,584.008z"
                            onMouseEnter={() => setHoveredCountry("480")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("480")}
                            className={`cursor-pointer ${hoveredCountry === "480" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="462" // Maldives
                            onMouseEnter={() => setHoveredCountry("462")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("462")}
                            className={`cursor-pointer ${hoveredCountry === "462" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("454")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("454")}
                            className={`cursor-pointer ${hoveredCountry === "454" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="484" // Mexico 
                            ...
                            onMouseEnter={() => setHoveredCountry("484")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("484")}
                            className={`cursor-pointer ${hoveredCountry === "484" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="458" // Malaysia
                            onMouseEnter={() => setHoveredCountry("458")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("458")}
                            className={`cursor-pointer ${hoveredCountry === "458" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("508")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("508")}
                            className={`cursor-pointer ${hoveredCountry === "508" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="516" // Namibia
                            ...
                            onMouseEnter={() => setHoveredCountry("516")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("516")}
                            className={`cursor-pointer ${hoveredCountry === "516" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="540" // New Caledonia
                            d="M798.706,602.576l-0.303,1.547l3.983,5.559l2.145,0.926l0.303-2.161L798.706,602.576L798.706,602.576z"
                            onMouseEnter={() => setHoveredCountry("540")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("540")}
                            className={`cursor-pointer ${hoveredCountry === "540" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="562" // Niger
                            ...
                            onMouseEnter={() => setHoveredCountry("562")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("562")}
                            className={`cursor-pointer ${hoveredCountry === "562" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="566" // Nigeria
                            ...
                            onMouseEnter={() => setHoveredCountry("566")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("566")}
                            className={`cursor-pointer ${hoveredCountry === "566" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="558" // Nicaragua
                            ...
                            onMouseEnter={() => setHoveredCountry("558")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("558")}
                            className={`cursor-pointer ${hoveredCountry === "558" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="528" // Netherlands 
                            ...
                            onMouseEnter={() => setHoveredCountry("528")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("528")}
                            className={`cursor-pointer ${hoveredCountry === "528" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="578" // Norway
                            onMouseEnter={() => setHoveredCountry("578")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("578")}
                            className={`cursor-pointer ${hoveredCountry === "578" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("524")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("524")}
                            className={`cursor-pointer ${hoveredCountry === "524" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="554" // New Zealand
                            onMouseEnter={() => setHoveredCountry("554")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("554")}
                            className={`cursor-pointer ${hoveredCountry === "554" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("512")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("512")}
                            className={`cursor-pointer ${hoveredCountry === "512" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="591" // Panama
                            ...
                            onMouseEnter={() => setHoveredCountry("591")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("591")}
                            className={`cursor-pointer ${hoveredCountry === "591" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="604" // Peru 
                            ...
                            onMouseEnter={() => setHoveredCountry("604")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("604")}
                            className={`cursor-pointer ${hoveredCountry === "604" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="598" // Papua New Guinea
                            onMouseEnter={() => setHoveredCountry("598")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("598")}
                            className={`cursor-pointer ${hoveredCountry === "598" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <g
                            id="608" // Philippines
                            onMouseEnter={() => setHoveredCountry("608")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("608")}
                            className={`cursor-pointer ${hoveredCountry === "608" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("586")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("586")}
                            className={`cursor-pointer ${hoveredCountry === "586" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="616" // Poland
                            ...
                            onMouseEnter={() => setHoveredCountry("616")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("616")}
                            className={`cursor-pointer ${hoveredCountry === "616" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="630" // Puerto Rico 
                            d="M249.297,482.068l-2.282-0.77l-1.833,1.149l0.917,1.071l3.121,0.458L249.297,482.068L249.297,482.068z"
                            onMouseEnter={() => setHoveredCountry("630")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("630")}
                            className={`cursor-pointer ${hoveredCountry === "630" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="620" // Portugal
                            onMouseEnter={() => setHoveredCountry("620")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("620")}
                            className={`cursor-pointer ${hoveredCountry === "620" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("600")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("600")}
                            className={`cursor-pointer ${hoveredCountry === "600" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="634" // Qatar
                            d="M527.273,463.018l-0.449,3.467l1.331,1.012l1.209-0.112l0.45-4.365l-1.047-0.752L527.273,463.018L527.273,463.018z"
                            onMouseEnter={() => setHoveredCountry("634")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("634")}
                            className={`cursor-pointer ${hoveredCountry === "634" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="642" // Romania
                            ...
                            onMouseEnter={() => setHoveredCountry("642")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("642")}
                            className={`cursor-pointer ${hoveredCountry === "642" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="688" // Serbia 
                            ...
                            onMouseEnter={() => setHoveredCountry("688")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("688")}
                            className={`cursor-pointer ${hoveredCountry === "688" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="643" // Russia
                            onMouseEnter={() => setHoveredCountry("643")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("643")}
                            className={`cursor-pointer ${hoveredCountry === "643" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("646")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("646")}
                            className={`cursor-pointer ${hoveredCountry === "646" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="682" // Saudi Arabia 
                            ...
                            onMouseEnter={() => setHoveredCountry("682")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("682")}
                            className={`cursor-pointer ${hoveredCountry === "682" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="090" // Solomon Islands
                            onMouseEnter={() => setHoveredCountry("090")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("090")}
                            className={`cursor-pointer ${hoveredCountry === "090" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <g
                            id="690" // Seychelles
                            onMouseEnter={() => setHoveredCountry("690")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("690")}
                            className={`cursor-pointer ${hoveredCountry === "690" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("729")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("729")}
                            className={`cursor-pointer ${hoveredCountry === "729" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="752" // Sweden
                            onMouseEnter={() => setHoveredCountry("752")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("752")}
                            className={`cursor-pointer ${hoveredCountry === "752" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("702")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("702")}
                            className={`cursor-pointer ${hoveredCountry === "702" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="705" // Slovenia
                            d="M442.708,405.076l-2.195,1.314l-4.097,0.898l0.82,2.368l2.87,0.034l2.646-2.213L442.708,405.076L442.708,405.076z"
                            onMouseEnter={() => setHoveredCountry("705")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("705")}
                            className={`cursor-pointer ${hoveredCountry === "705" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="703" // Slovakia
                            ...
                            onMouseEnter={() => setHoveredCountry("703")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("703")}
                            className={`cursor-pointer ${hoveredCountry === "703" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="694" // Sierra Leone
                            d="M372.804,509.79l4.884,4.72l3.483-4.227l-2.179-3.415l-3,0.303L372.804,509.79L372.804,509.79z"
                            onMouseEnter={() => setHoveredCountry("694")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("694")}
                            className={`cursor-pointer ${hoveredCountry === "694" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="686" // Senegal 
                            ...
                            onMouseEnter={() => setHoveredCountry("686")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("686")}
                            className={`cursor-pointer ${hoveredCountry === "686" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="706" // Somalia
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("740")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("740")}
                            className={`cursor-pointer ${hoveredCountry === "740" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="728" // South Sudan
                            ...
                            onMouseEnter={() => setHoveredCountry("728")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("728")}
                            className={`cursor-pointer ${hoveredCountry === "728" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="678" // Sao Tome and Principe
                            onMouseEnter={() => setHoveredCountry("678")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("678")}
                            className={`cursor-pointer ${hoveredCountry === "678" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("222")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("222")}
                            className={`cursor-pointer ${hoveredCountry === "222" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="760" // Syria
                            ...
                            onMouseEnter={() => setHoveredCountry("760")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("760")}
                            className={`cursor-pointer ${hoveredCountry === "760" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="748" // Eswatini 
                            d="M482.531,596.983l-2.169,0.361l-0.935,2.552l1.659,1.513h2.015l1.702-2.446L482.531,596.983L482.531,596.983z"
                            onMouseEnter={() => setHoveredCountry("748")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("748")}
                            className={`cursor-pointer ${hoveredCountry === "748" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="148" // Chad
                            ...
                            onMouseEnter={() => setHoveredCountry("148")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("148")}
                            className={`cursor-pointer ${hoveredCountry === "148" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="768" // Togo
                            d="M408.495,516.81l2.316-1.356l-0.053-8.946l-1.504-2.438l-0.967,0.812L408.495,516.81L408.495,516.81z"
                            onMouseEnter={() => setHoveredCountry("768")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("768")}
                            className={`cursor-pointer ${hoveredCountry === "768" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="764" // Thailand
                            ...
                            onMouseEnter={() => setHoveredCountry("764")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("764")}
                            className={`cursor-pointer ${hoveredCountry === "764" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="762" // Tajikistan
                            ...
                            onMouseEnter={() => setHoveredCountry("762")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("762")}
                            className={`cursor-pointer ${hoveredCountry === "762" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="795" // Turkmenistan
                            ...
                            onMouseEnter={() => setHoveredCountry("795")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("795")}
                            className={`cursor-pointer ${hoveredCountry === "795" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="788" // Tunisia
                            ...
                            onMouseEnter={() => setHoveredCountry("788")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("788")}
                            className={`cursor-pointer ${hoveredCountry === "788" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="792" // Turkey
                            ...
                            onMouseEnter={() => setHoveredCountry("792")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("792")}
                            className={`cursor-pointer ${hoveredCountry === "792" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("780")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("780")}
                            className={`cursor-pointer ${hoveredCountry === "780" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="158" // Taiwan 
                            d="M695.686,453.76l-3.06,2.334l-0.163,4.494l2.646,3.078l0.656-0.58L695.686,453.76L695.686,453.76z"
                            onMouseEnter={() => setHoveredCountry("158")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("158")}
                            className={`cursor-pointer ${hoveredCountry === "158" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="834" // Tanzania
                            ...
                            onMouseEnter={() => setHoveredCountry("834")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("834")}
                            className={`cursor-pointer ${hoveredCountry === "834" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="804" // Ukraine
                            ...
                            onMouseEnter={() => setHoveredCountry("804")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("804")}
                            className={`cursor-pointer ${hoveredCountry === "804" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="800" // Uganda
                            ...
                            onMouseEnter={() => setHoveredCountry("800")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("800")}
                            className={`cursor-pointer ${hoveredCountry === "800" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="840" // United States
                            onMouseEnter={() => setHoveredCountry("840")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("840")}
                            className={`cursor-pointer ${hoveredCountry === "840" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("858")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("858")}
                            className={`cursor-pointer ${hoveredCountry === "858" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="860" // Uzbekistan 
                            ...
                            onMouseEnter={() => setHoveredCountry("860")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("860")}
                            className={`cursor-pointer ${hoveredCountry === "860" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="670" // Saint Vincent and the Grenadines
                            onMouseEnter={() => setHoveredCountry("670")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("670")}
                            className={`cursor-pointer ${hoveredCountry === "670" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("862")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("862")}
                            className={`cursor-pointer ${hoveredCountry === "862" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="704" // Vietnam
                            ...
                            onMouseEnter={() => setHoveredCountry("704")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("704")}
                            className={`cursor-pointer ${hoveredCountry === "704" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <g
                            id="548" // Vanuatu
                            onMouseEnter={() => setHoveredCountry("548")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("548")}
                            className={`cursor-pointer ${hoveredCountry === "548" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <g
                            id="887" // Yemen
                            onMouseEnter={() => setHoveredCountry("887")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("887")}
                            className={`cursor-pointer ${hoveredCountry === "887" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        >
                        ...
                        <path
                            ...
                            onMouseEnter={() => setHoveredCountry("710")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("710")}
                            className={`cursor-pointer ${hoveredCountry === "710" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="894" // Zambia 
                            ...
                            onMouseEnter={() => setHoveredCountry("894")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("894")}
                            className={`cursor-pointer ${hoveredCountry === "894" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                        <path
                            id="716" // Zimbabwe
                            ...
                            onMouseEnter={() => setHoveredCountry("716")}
                            onMouseLeave={() => setHoveredCountry(null)}
                            onClick={() => handleCountryClick("716")}
                            className={`cursor-pointer ${hoveredCountry === "716" ? "fill-blue-400" : "fill-gray-300 hover:fill-blue-200"
                                }`}
                        />
                    </g>
                </svg>
            ...
            {showPopup && (
                ...
                >
                    ...
                    {/* Modal content */}
                    <div
                        className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[80vh] overflow-hidden animate-in zoom-in-95 duration-200"
                        onClick={(e) => e.stopPropagation()}
                    >
                        {/* Header with black gradient */}
                        <div className="bg-gradient-to-r from-gray-800 to-black px-6 py-5 text-white">
                            <div className="flex items-center justify-between">
                                <div>
                                    <h2 className="text-2xl font-bold">
                                        {countries.find((c) => c.code === selectedToCountry)?.name || "Country"}
                                    </h2>
                                    <p className="text-gray-300 text-sm mt-1">Tariff Information</p>
                                </div>
                                <button
                                    onClick={() => setShowPopup(false)}
